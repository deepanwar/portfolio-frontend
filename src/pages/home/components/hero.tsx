...
import SpeechEmoji from "@/assets/speech-balloon-emoji.png";
          ...
          <Card className="rounded-3xl px-14 py-12 border-none">
            <div className="flex items-end mb-6 gap-x-2">
              ...
              <motion.div
                ...
                className="bg-background text-xs px-2.5 py-1.5 border hover:border-neutral-400 rounded-3xl transition-colors duration-200"
              >
                <Link to="/contact">
